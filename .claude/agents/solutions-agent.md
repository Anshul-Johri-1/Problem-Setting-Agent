...
description: Post-approval only. Produces the 7–10 file solution roster (correct, brute, and WA/RE/TL variants), each locally verified to behave as intended. A WA file that fails nothing is a bug, not a deliverable.
